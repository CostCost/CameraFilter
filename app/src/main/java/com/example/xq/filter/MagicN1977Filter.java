...
public class MagicN1977Filter extends GPUImageFilter {
	...
	public MagicN1977Filter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtil.readShaderFromRawResource(R.raw.n1977));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtil.loadTexture(MagicParams.context, "filter/n1977map.png");
				inputTextureHandles[1] = OpenGlUtil.loadTexture(MagicParams.context, "filter/n1977blowout.png");
		    }
	    });
	}
}
