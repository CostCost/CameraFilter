...
import com.example.xq.filter.MagicAmaroFilter;
import com.example.xq.filter.MagicAntiqueFilter;
import com.example.xq.filter.MagicBrannanFilter;
import com.example.xq.filter.MagicBrooklynFilter;
import com.example.xq.filter.MagicCalmFilter;
import com.example.xq.filter.MagicCoolFilter;
import com.example.xq.filter.MagicCrayonFilter;
import com.example.xq.filter.MagicEarlyBirdFilter;
import com.example.xq.filter.MagicEmeraldFilter;
import com.example.xq.filter.MagicHefeFilter;
import com.example.xq.filter.MagicN1977Filter;
import com.example.xq.filter.MagicWhiteCatFilter;
...
public class GPUImageFilterTools {
    ...
    public static void init() {
        ...
        filters.addFilter("HEFE", FilterType.HEFE);
        filters.addFilter("N1977", FilterType.N1977);
        filters.addFilter("EMERALD", FilterType.EMERALD);
        filters.addFilter("EARLYBIRD", FilterType.EARLYBIRD);
        filters.addFilter("BROOKLYN", FilterType.BROOKLYN);
        filters.addFilter("BRANNAN", FilterType.BRANNAN);
        filters.addFilter("ANTIQUE", FilterType.ANTIQUE);
        filters.addFilter("AMARO", FilterType.AMARO);
        filters.addFilter("WHITECAT", FilterType.WHITECAT);
        filters.addFilter("Cool", FilterType.COOL);
        filters.addFilter("CALM", FilterType.CALM);
...
//        filters.addFilter("Kuwahara", FilterType.KUWAHARA);
    ...
    public enum FilterType {
        CONTRAST, HEFE,N1977,EMERALD,EARLYBIRD,CRAYON,BROOKLYN,BRANNAN,ANTIQUE,AMARO,COOL,WHITECAT,CALM,GRAYSCALE, SHARPEN, SEPIA, SOBEL_EDGE_DETECTION, THREE_X_THREE_CONVOLUTION, FILTER_GROUP, EMBOSS, POSTERIZE, GAMMA, BRIGHTNESS, INVERT, HUE, PIXELATION,
