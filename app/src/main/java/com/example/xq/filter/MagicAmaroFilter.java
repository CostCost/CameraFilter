...
public class MagicAmaroFilter extends GPUImageFilter {
	...
	public MagicAmaroFilter(){
		super(NO_FILTER_VERTEX_SHADER, OpenGlUtil.readShaderFromRawResource(R.raw.amaro));
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    public void run(){
		    	inputTextureHandles[0] = OpenGlUtil.loadTexture(MagicParams.context, "filter/brannan_blowout.png");
				inputTextureHandles[1] = OpenGlUtil.loadTexture(MagicParams.context, "filter/overlaymap.png");
				inputTextureHandles[2] = OpenGlUtil.loadTexture(MagicParams.context, "filter/amaromap.png");
		    }
	    });
	}
}
